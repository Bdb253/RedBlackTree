...
public class RBTreeClass
{
    ...
    * 
    * @param inData
    *           char data to be added to RBTree
    * 
    ...
    * 
    * @param localRoot
    *           RBT_Node tree root reference at the current recursion level
    * 
    * @param inData
    *           char item to be added to RBTree
    * 
   ...
   private RBT_Node insertHelper(RBT_Node localRoot, char inData)
   {
      ...
      // value less than local root go left
      if (inData < localRoot.nodeData)
      {
         // test leftRef for null
      ...
      // value more than local root go right
      if (inData > localRoot.nodeData)
      {
         // test leftRef for null
      ...
      // if values are even then you don't do anything
      return null;
   }
    ...
    * 
    * @param localRef
    *           node reference for the local tree being managed
    */
    ...
    * 
    * @param localRef
    *           reference of current item
    * 
    * @param parRef
    *           reference of current item parent
    * 
    * @param grndParRef
    *           reference of current item grandparent
    */
    ...
    * 
    * @param one
    *           one of the RBT nodes
    * 
    * @param other
    *           other of the RBT nodes
    */
   ...
   private boolean searchHelper(RBT_Node localRoot, char searchData)
   {
      if (localRoot != null)
      {
         ...
         // value equal then search successful
         if (searchData == localRoot.nodeData)
         {
   ...
   private int treeHeightHelper(RBT_Node localRoot)
   {
      ...
      return getMax(treeHeightHelper(localRoot.leftChildRef),
            treeHeightHelper(localRoot.rightChildRef)) + 1;
    ...
    * 
    * @param traverseCode
    *           int code for selecting RBTree traversal method, accepts
    ...
    * 
    * @param workingNode
    *           node reference at current recursive level
    * 
    * @param nodeHeight
    *           height of tree plus two for current height of nodes, including
    *           lowermost null children
    * 
    * @param displayLevel
    *           level of tree at which the current line of display is to be
    *           presented
    * 
    * @param workingLevel
    *           current level during recursive actions
    */
         ...
         int displayLevel, int workingLevel)
   {
      ...
      {
         displayAtTreeLevel(workingNode.rightChildRef, nodeHeight, displayLevel,
               workingLevel + 1);
      }
    ...
    * 
    * @param data
    *           data value to display, either letter or color data
    * 
    * @param nodeHeight
    *           height of tree plus two for current height of nodes, including
    *           lowermost null children
    ...
    * 
    * @param displayLevel
    *           level of the tree at which the display will be applied
    * 
    * @param workingLevel
    *           level of tree just below non-null node at which method is
    *           currently working
    */
    ...
    * 
    * @param displayCode
    *           specifies whether to set tree to display data character or color
    *           letter
    */
    ...
    * 
    * @param one
    *           one of two values to be tested
    * 
    * @param other
    *           other of two values to be tested
    * 
